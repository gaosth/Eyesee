           ...
           <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
              <div class = "grid grid-cols-2 gap-4 mx-10 h-2/3">
                 ...
                 <div class = "px-4 py-10 h-1/1">
                    ...
                    <div class = "flex text-left mx-4 my-4 text-yellow-800">这幅画中的树木笔触较为宽厚，墨色均匀，显示出了某种柔和与层次感，这些特点与刘松年的风格更为接近。而梁楷的作品，则以其更为简练、流畅的线条和对细节的深入描绘而著称，其树木作品常显示出较强的节奏感和动态。因此，这幅画在风格上与梁楷的典型作品有较大差别，这引起了对作品真实性的怀疑。</div>
                 </div>
              </div>
              <div class = "h-1/5 mx-10">
                 <div class = " px-4 flex justify-start">
                    ...
                    <div class = "flex text-left mx-4 my-4 text-xl text-yellow-800 underline underline-offset-8">这幅画在题材和材质上符合梁楷的风格，但其扇面形制和淡彩设色较少见于梁楷作品，同时，印章位置的不典型和树木笔触的风格与刘松年相近而非梁楷，这些因素均引发了对画作真实性的怀疑。因此，建议深入分析画作的风格和技术细节来准确鉴定其真伪。</div>
              </div>
...
import bbox1 from '@/components/bbox/bbox4.json'
import { ref, onMounted } from 'vue'
import heatmap from '@/components/case4/heatmap3.vue'
import heatmap2 from '@/components/case4/heatmap5.vue'
import heatmap3 from '@/components/case4/heatmap1.vue'
import heatmap4 from '@/components/case4/heatmap2.vue'
