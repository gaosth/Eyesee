                ...
                <div class="col-span-2 ">
                    ...
                    <div>
                       <div class = "flex flex-col my-6 w-1/1 h-64 border-yellow-800 rounded-2xl border-4 bg-orange-100 px-4 py-3">
                            <div>
                                <div class="rounded-xl bg-yellow-600 text-xl text-white mb-2 px-6 py-2 w-4/6">马远山水画</div>
                                ...
                                <p class="underline underline-offset-8 text text-yellow-900 mb-2">用户输入：这是我家传的古画，长205cm。宽106cm，据说是马远的真迹，帮我鉴定一下是否属实</p>
