            ...
            <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
               <div class = "grid grid-cols-2 gap-4 mx-10 h-2/3">
                  ...
                  <div class = "px-4 py-10 h-1/1">
                     ...
                     <div class = "flex text-left mx-4 my-4 text-yellow-800">虽然这幅画在主题选择、画幅形制、使用的材料、绘画技法和颜色搭配等方面，都与马远的偏好和风格紧密相符，但印章位置的异常和笔触、皴法的不同寻常表现，都在一定程度上引起了对该作品真实性的怀疑。因此，需要进一步深入分析和考证，才能更加确切地评判这幅作品的真伪。</div>
                  </div>
               </div>
