     ...
     <div class="flex flex-row min-h-screen">
        <div class="w-1/3 h-screen bg-orange-100">
         ...
         <div class = "h-4/5 w-1/1 bg-transparent mx-10 relative">
            ...
            :style="{
               left: ((area.bbox[0]-area.bbox[2]/2) * this.$refs.urlInfo.offsetWidth) + 'px', 
               top: ((area.bbox[1]-area.bbox[3]/2) * this.$refs.urlInfo.offsetHeight) + 'px', 
               width: (area.bbox[2] * this.$refs.urlInfo.offsetWidth) + 'px', 
               height: (area.bbox[3] * this.$refs.urlInfo.offsetHeight) + 'px',
               }"
