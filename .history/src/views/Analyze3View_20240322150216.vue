           ...
           <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
              ...
              <div class = "h-1/5 mx-10">
                 <div class = " px-4 flex justify-start">
                    ...
                    <div class = "flex text-center mx-4 my-4 text-xl text-yellow-800 underline underline-offset-8">这幅画在题材和材质上符合梁楷的风格，但其扇面形制和淡彩设色较少见于梁楷作品，同时，印章位置的不典型和树木笔触的风格与刘松年相近而非梁楷，这些因素均引发了对画作真实性的怀疑。因此，建议深入分析画作的风格和技术细节来准确鉴定其真伪。</div>
              </div>
