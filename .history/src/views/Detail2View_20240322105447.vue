                ...
                <div class="col-span-2 ">
                    ...
                    <div>
                       <div class = "flex flex-col my-6 w-1/1 h-64 border-yellow-800 rounded-2xl border-4 bg-orange-100 px-4 py-3">
                            <div>
                                <div class="rounded-xl bg-yellow-600 text-xl text-white mb-2 px-6 py-2 w-4/6">郭熙山水画</div>
                                <p class="underline underline-offset-8 text text-yellow-900 mb-2">来源：家传</p>
                                <p class="underline underline-offset-8 text text-yellow-900 mb-2">长：188.8cm  宽： 109.1cm</p>
                                <p class="underline underline-offset-8 text text-yellow-900 mb-2">作者：郭熙 朝代：宋</p>
                                <p class="underline underline-offset-8 text text-yellow-900 mb-2">用户输入：这是我家传的古画，据说是宋代郭熙的真迹，帮我鉴定一下</p>
...
import Mt1 from '@/assets/case2/mountain1/01.png'
import Mt2 from '@/assets/case2/mountain2/02.png'
import Tr1 from '@/assets/case2/tree1/01.png'
import Tr2 from '@/assets/case2/tree2/02.png'
