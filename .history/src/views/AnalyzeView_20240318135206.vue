               ...
               <div class = "grid grid-cols-2 gap-4 mx-10 h-1/2">
                  <div class = "px-4 py-10 h-1/1">
                     ...
                     <div class="flex border-yellow-800 border-dashed rounded-2xl border-4 mr-4 mt-4 h-2/3">
                        <heatmap v-if="bbox1[chosen].object.value == '印章'"/>
                     </div>
...
import heatmap2 from '@/components/Heatmap.vue'
import heatmap3 from '@/components/Heatmap.vue'
import heatmap4 from '@/components/Heatmap.vue'
import heatmap5 from '@/components/Heatmap.vue'
import heatmap6 from '@/components/Heatmap.vue'
import heatmap7 from '@/components/Heatmap.vue'
...
export default{
    ...
    methods: {
      ...
      async last(){
         ...
         console.log("This is the number after: ",this.chosen)
         console.log(this.bbox1[this.chosen].object)
      },
      urlInfo(e) {
