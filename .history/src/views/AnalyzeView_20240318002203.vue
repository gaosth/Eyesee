     ...
     <div class="flex flex-row min-h-screen">
        <div class="w-1/3 h-screen bg-orange-100">
         ...
         <div class = "h-4/5 w-1/1 bg-transparent mx-10 relative">
            ...
            class="absolute border-4 border-dashed border-yellow-950 text-lg text-transparent hover:text-white hover:bg-white hover:bg-opacity-25"
            :style="{
            ...
            >
               <p class="absolute -top-10 left-2 whitespace-nowrap">{{ area.object[0] }}</p>
            </button>
         </div>
        </div>
