<template>
    <div class="flex flex-row min-h-screen">
        ...
        <div class="w-1/4 h-screen bg-orange-100">
            ...
            <div class = "mx-10 my-4 shadow-[0_0_10px_rgba(0,0,0,0.10)] bg-white rounded-xl border-black/10 flex justify-start">
            ...
            <div class="grid grid-cols-2 gap-4 mx-10">
                ...
                <div class="text-center px-3 py-10 bg-red-100 rounded-lg">01</div>
                <div class="text-center px-3 py-10 bg-blue-100 rounded-lg">01</div>
                <div class="text-center px-3 py-10 bg-green-100 rounded-lg">01</div>
                <div class="text-center px-3 py-10 bg-yellow-100 rounded-lg">01</div>
            </div>
        </div>
    </div>
</template>
