    ...
    <div class="flex flex-row min-h-screen">
        <div class="w-3/4 h-screen bg-orange-50">
            <div class = "flex mx-10 mt-6 justify-start">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 bg-white">
                ...
                <div class="mt-0.5 text-2xl ml-2 font-bold text-yellow-900">
                    待鉴定画作
                </div>
            </div>
            <div class = "flex mx-10 my-6 w-1/1 h-1/2 border-yellow-800 rounded-2xl border-4">
                <div class = "mx-10 my-10 bg-transparent overflow-auto touch-auto">
