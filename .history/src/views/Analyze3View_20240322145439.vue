           ...
           <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
              <div class = "grid grid-cols-2 gap-4 mx-10 h-2/3">
                 ...
                 <div class = "px-4 py-10 h-1/1">
                    ...
                    <div class = "flex text-left mx-4 my-4 text-yellow-800">这幅画的树木笔触表现出较为细腻和柔和的特点，枝条呈现流畅的线条，墨色的渲染呈现出层次感，这些特征在刘松年的作品中较为常见。与之相比，梁楷的树木笔触则更倾向于使用更加强烈和有力的线条，树木的枝条和叶片常常以更为简洁和概括的方式表现。由于这幅画的笔触和风格更接近刘松年的绘画习惯，而与梁楷的简练、意境深远的风格有所差异，所以对这幅画的真实性产生了怀疑。</div>
                 </div>
              </div>
