           ...
           <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
              <div class = "grid grid-cols-2 gap-4 mx-10 h-2/3">
                 ...
                 <div class = "px-4 py-10 h-1/1">
                    ...
                    <div class = "flex text-center mx-4 my-4 text-lg text-yellow-800">这个疑似郭熙作品的山峰切片，可以发现皴法中笔触的粗细、力度以及墨色的运用与李唐的风格有相似之处。笔触显得比较强劲和直接，皴纹之间的对比比较突出，这与李唐的风格相符。郭熙的作品中皴法通常比较含蓄，线条更加流畅，墨色层次更为细腻。</div>
                 </div>
              </div>
