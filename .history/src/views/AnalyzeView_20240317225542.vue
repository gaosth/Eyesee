<template>
     <div class="flex flex-row min-h-screen">
        <div class="w-1/3 h-screen bg-orange-100">
         ...
         <div class = "h-4/5 w-1/1 bg-transparent mx-10">
            <img :src="case_Image" alt="" class = "scale-100 relative" >
            <div v-for="(area, index) in bbox1" :key="index" 
               class="absolute border-red-500 border-2 bg-transparent" 
               :style="{
                  left: (area.bbox[0] * imgWidth) + 'px', 
                  top: (area.bbox[1] * imgHeight) + 'px', 
