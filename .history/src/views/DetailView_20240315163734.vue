<template>
    <div class="flex flex-row min-h-screen">
        ...
        <div class="w-1/4 h-screen bg-orange-100">
            ...
            <div class = "mx-10 my-4 shadow-[0_0_10px_rgba(0,0,0,0.10)] bg-white rounded-xl border-black/10">
                <textarea class="mx-2 my-2 resize-none focus:outline-none border-0 text-xl"></textarea>
            </div>
        </div>
    </div>
</template>
