    ...
    <div class="flex flex-row min-h-screen">
        <div class="w-3/4 h-screen bg-orange-50">
            <div class = "flex mx-10 mt-6 justify-start">
                ...
                <div class="flex self-center text-3xl ml-2 font-bold text-yellow-900">
                    待鉴定画作
                </div>
            </div>
            ...
            <div class = "grid grid-cols-5 gap-4 mx-10 mt-6">
                <div class="col-span-2 bg-white flex justify-start">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12">
                ...
                <div class = "flex flex-col mx-10 my-6 w-1/1 h-1/2 border-yellow-800 rounded-2xl border-4 bg-orange-100"></div>
