            ...
            <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
               <div class = "grid grid-cols-2 gap-4 mx-10 h-2/3">
                  <div class = "px-4 py-10 h-1/1">
                     ...
                     <div class = "flex text-center mx-4 my-4 text-yellow-800">这幅图中的山峰线条柔和，笔触较为宽厚，墨色渲染较为均匀，表现的皴法有“卷云皴”的特点。而马远作品中的山峰线条相对直接且有一定角度，像是斧头劈砍的痕迹，主要为“斧劈皴”。因此，这座山峰的笔触和马远真迹中的笔触有一定差别，这引起了对作品真实性的怀疑。</div>
                  </div>
                  <div class = "px-4 py-10 h-1/1">
                     <div class = "flex justify-start">
                        <div>
