            ...
            <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
               <div class = "grid grid-cols-2 gap-4 mx-10 h-2/3">
                  <div class = "px-4 py-10 h-1/1">
                     ...
                     <div class="flex justify-center border-yellow-800 border-dashed rounded-2xl border-4 mr-4 mt-4 h-1/2 py-2">
                     ...
                     <div class = "flex text-center mx-4 my-4 text-lg text-yellow-800 overflow-auto touch-auto">这幅图中的山峰线条柔和，笔触较为宽厚，墨色渲染较为均匀，表现的皴法有“卷云皴”的特点。而马远作品中的山峰线条相对直接且有一定角度，像是斧头劈砍的痕迹，主要为“斧劈皴”。因此，这座山峰的笔触和马远真迹中的笔触有一定差别，这引起了对作品真实性的怀疑。</div>
                  </div>
                  <div class = "px-4 py-10 h-1/1">
                     <div class = "flex justify-start">
                        <div>
                     ...
                     <div class="flex border-yellow-800 border-dashed rounded-2xl border-4 mr-4 mt-4 h-1/2">
                        <!-- relationship here -->
               ...
               <div class = "h-1/5 mx-10">
                  <div class = " px-4 flex justify-start">
                     ...
                     <div class = "flex text-left mx-4 my-4 text-xl text-yellow-800 underline underline-offset-8 tracking-wide leading-8">
                        虽然这幅画在主题选择、画幅形制、使用的材料、绘画技法和颜色搭配等方面，都与马远的偏好和风格紧密相符，但印章位置的异常和笔触、皴法的不同寻常表现，都在一定程度上引起了对该作品真实性的怀疑。因此，需要进一步深入分析和考证，才能更加确切地评判这幅作品的真伪。
                     </div>
               </div>
