     ...
     <div class="flex flex-row min-h-screen">
        ...
        <div class="w-2/3 h-screen bg-orange-100">
         <div class = "flex mx-10 mt-10 justify-start">
            ...
            <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50">
               ...
               <div class = "h-2/5 mx-10 bg-white">
                  <div class = " px-4 flex justify-start">
                     ...
                     <div class = "flex text-center mx-4 my-4 text-xl text-yellow-800">这里是一些描述性的文字</div>
               </div>
            </div>
        </div>
     </div>
