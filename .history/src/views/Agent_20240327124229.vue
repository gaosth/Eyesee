<template>
      <main class="w-screen h-screen bg-orange-100">
          <!-- Right side content here -->
          <div 
            class="absolute top-6 right-0 w-1/1 h-4/5 border-t-0 border-transparent bg-vert-light-gradient bg-transparent overflow-y-auto"
          >
            <div
          ...
          <div class = "absolute bottom-6 right-0 w-1/1 border-t-0 border-transparent bg-vert-light-gradient bg-transparent">
