    ...
    <div class="flex flex-row min-h-screen">
        <div class="w-3/4 h-screen bg-orange-50">
            <div class = "flex mx-10 mt-6 justify-start">
                ...
                <div class="flex self-center text-3xl ml-2 font-bold text-yellow-900 font-serif">
                    待鉴定画作
                </div>
            </div>
            ...
            <div class = "grid grid-cols-5 gap-6 mx-10 mt-6">
                <div class="col-span-2 ">
                    ...
                    <div>
                       <div class = "flex flex-col my-6 w-1/1 h-60 border-yellow-800 rounded-2xl border-4 bg-orange-100">
                            <div>
