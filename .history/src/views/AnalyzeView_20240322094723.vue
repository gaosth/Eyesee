            ...
            <div class = "flex flex-col mx-10 my-6 w-1/1 h-4/5 border-yellow-800 rounded-2xl border-4 bg-orange-50 relative">
               <div class = "grid grid-cols-2 gap-4 mx-10 h-2/3">
                  <div class = "px-4 py-10 h-1/1">
                     ...
                     <div class="flex justify-center border-yellow-800 border-dashed rounded-2xl border-4 mr-4 mt-4 h-50 py-2">
                     ...
                     <div class = "flex text-left mx-4 my-4 text-yellow-800">印章位置的罕见性与画家常规习惯不符，引发了对作品真实性的质疑。</div>
                  </div>
                  <div class = "px-4 py-10 h-1/1">
                     <div class = "flex justify-start">
                        <div>
                     ...
                     <div class="flex border-yellow-800 border-dashed rounded-2xl border-4 mr-4 mt-4 h-40">
                        <!-- relationship here -->
                        <imgLink3 v-if="chosen == 8"/>
                        <imgLink4 v-if="chosen == 9"/>
                        <imgLink1 v-if="chosen == 2"/>
               ...
               <div class = "h-1/5 mx-10">
                  <div class = " px-4 flex justify-start">
                     ...
                     <div class = "flex text-left mx-4 my-4 text-xl text-yellow-800 underline underline-offset-8 tracking-wide leading-8">
                        尽管这幅画在基本特征上符合马远的习惯，但其印章位置和山石、树木笔触风格的异常引起了真实性的怀疑，需要更深入的分析来确定真伪。
                     </div>
               </div>
...
import imgLink1 from '@/components/case1/imgLink1.vue'
import imgLink2 from '@/components/case1/imgLink2.vue'
import imgLink3 from '@/components/case1/imgLink3.vue'
import imgLink4 from '@/components/case1/imgLink4.vue'
